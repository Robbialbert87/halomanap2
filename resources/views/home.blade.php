            ...
            <header class="bg-white/90 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100 shadow-sm">
                <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <p class="font-bold text-lg text-blue-800 leading-tight">Halo <span
            ...
            <section class="bg-white">
                <div class="max-w-7xl mx-auto px-6 py-20 flex items-center gap-16">
                    <div class="flex-1">
                        ...
                        <p class="text-blue-600 font-semibold italic mb-8">"Salurkan Aspirasi Anda dengan Mudah &amp;
                            Transparan"</p>
        ...
        <p class="text-xs text-gray-500">Isi Survei Kepuasan Masyarakat</p>
            ...
            <footer class="bg-gray-900 text-gray-400 py-10">
                <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-xl bg-blue-600 flex items-center justify-center text-white"><i
        ...
        <div class="md:hidden flex flex-col min-h-screen">
            ...
            <header class="bg-white sticky top-0 z-50 px-4 h-14 flex items-center justify-between border-b border-gray-100">
                ...
                <button class="relative text-gray-500">
                    ...
                    <span
                        class="absolute -top-1 -right-1 bg-red-500 text-white text-[9px] font-bold w-3.5 h-3.5 rounded-full flex items-center justify-center border border-white">3</span>
                </button>
            </header>
            ...
            <main class="flex-1 px-4 py-5 overflow-y-auto no-scrollbar pb-24">
                ...
                <div class="grid grid-cols-2 gap-3 mb-6">
                    <a href="/pengaduan/buat?type=Pengaduan"
                        class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center gap-2">
                        <div
                            class="w-12 h-12 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xl">
                            <i class="fa-solid fa-circle-exclamation"></i>
                        </div>
                        <div>
...
<a href="https://skm.go.id/share/instansi/cf0fe4fb-d51e-40e0-a3e7-4b6fbb5918b8/2" target="_blank" rel="noopener noreferrer"
    ...
    <div>
        <h3 class="text-sm font-bold text-green-500">Survei</h3>
        <p class="text-[10px] text-gray-500 mt-0.5">Isi Survei Kepuasan</p>
    </div>
</a>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
                    ...
                    <form action="{{ route('pengaduan.track') }}" method="GET" class="space-y-3">
                        <input type="text" name="ticket_number" placeholder="Masukkan nomor tiket"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-blue-500 uppercase font-mono tracking-wider">
                        <button type="submit"
                            class="w-full bg-blue-600 text-white font-semibold rounded-lg px-4 py-2.5 text-sm">
                            Cek Status
                        </button>
                    </form>
                </div>
            ...
            <!-- BOTTOM NAV MOBILE -->
            <nav
                class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-between items-end px-5 py-2 pb-4 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.07)]">
                <a href="/" class="flex flex-col items-center gap-1 text-blue-600 w-14">
                    <i class="fa-solid fa-house text-xl"></i>
                    <span class="text-[10px] font-medium">Beranda</span>
                </a>
                <a href="{{ route('pengaduan.track') }}"
                    class="flex flex-col items-center gap-1 text-gray-400 hover:text-blue-500 transition-colors w-14">
                ...
                <div class="relative w-14 flex justify-center">
                    <a href="/pengaduan/buat"
                        class="absolute -top-9 w-14 h-14 bg-blue-600 text-white rounded-full flex items-center justify-center shadow-lg shadow-blue-500/40 border-4 border-white">
                        <i class="fa-solid fa-plus text-xl"></i>
                    </a>
                    <span
                        class="text-[10px] font-medium text-gray-400 mt-6 text-center leading-none">Buat<br>Laporan</span>
                </div>
                <a href="#"
                    class="flex flex-col items-center gap-1 text-gray-400 hover:text-blue-500 transition-colors w-14">
