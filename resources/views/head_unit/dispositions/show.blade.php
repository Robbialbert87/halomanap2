...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('head-unit.dispositions.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                    ...
                    <form action="{{ route('head-unit.dispositions.selesai', $workflow->id) }}" method="POST" onsubmit="var btn=this.querySelector('button[type=submit]'); if(confirm('Tandai pengaduan selesai ditangani?')){btn.disabled=true; return true;} return false;">
                        @csrf
                        <div class="mb-3">
                ...
                <div class="bg-red-50 border border-red-100 rounded-xl p-4">
                    ...
                    <form action="{{ route('head-unit.dispositions.eskalasi', $workflow->id) }}" method="POST" onsubmit="var btn=this.querySelector('button[type=submit]'); if(confirm('Eskalasi pengaduan ke jabatan atasan?')){btn.disabled=true; return true;} return false;">
                        @csrf
                        <div class="mb-3">
