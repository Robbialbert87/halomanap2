        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                    ...
                    <form action="{{ route('kabid.dispositions.selesai', $workflow->id) }}" method="POST" onsubmit="return confirm('Tandai pengaduan selesai ditangani?')">
                        @csrf
                        <div class="mb-3">
                ...
                <div class="bg-red-50 border border-red-100 rounded-xl p-4">
                    ...
                    <form action="{{ route('kabid.dispositions.eskalasi', $workflow->id) }}" method="POST" onsubmit="return confirm('Eskalasi pengaduan ke jabatan atasan?')">
                        @csrf
                        <div class="mb-3">
