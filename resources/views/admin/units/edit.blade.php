            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="entry_jabatan_id" required
                        ...
                        @foreach($jabatans as $jabatan)
                            <option value="{{ $jabatan->id }}" {{ old('entry_jabatan_id', $unit->entry_jabatan_id) == $jabatan->id ? 'selected' : '' }}>
                ...
                <div class="flex items-center mt-6">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_public" value="1" {{ old('is_public', $unit->is_public) ? 'checked' : '' }}
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" rows="2"
                        class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                        placeholder="Keterangan opsional tentang unit ini">{{ old('keterangan', $unit->keterangan) }}</textarea>
                </div>
                <div>
