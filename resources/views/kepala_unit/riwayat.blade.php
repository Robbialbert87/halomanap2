...
@section('title', 'Riwayat Pengaduan Unit - Halo MANAP')

@section('admin_content')
<div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Riwayat Pengaduan Unit</h1>
...
<div class="space-y-3 md:hidden">
    @forelse($workflows as $wf)
    <a href="{{ route('kepala-unit.dispositions.show', $wf->uuid) }}" class="block bg-white rounded-xl shadow-sm border border-gray-100 p-4 active:scale-[0.98] transition-transform">
