...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ $fromRiwayat ? route('kasi.riwayat') : route('kasi.dispositions.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
