...
class DummyTicketSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $waNumber = UserFactory::DEFAULT_WA_NUMBER;
        ...
        foreach ($tickets as $data) {
            ...
            Ticket::updateOrCreate(['ticket_number' => $ticketNumber], $data);
        }

        $this->command->info('10 dummy tickets berhasil dibuat.');
        $this->command->line('   (Semua notifikasi WA akan dikirim ke: '.UserFactory::DEFAULT_WA_NUMBER.' — nomor WA tunggal untuk testing.)');
    }
}
